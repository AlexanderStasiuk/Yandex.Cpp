...
private:
  ...
  void Shrink() {
    ...
    class ProxyPolynomial {
    public:
        ProxyPolynomial(Polynomial& poly, size_t degree)
            : poly_(poly), degree_(degree) {}

        ProxyPolynomial& operator=(T value) {
...
public:
  ...
  T operator [](size_t degree) const {
    ...
    ProxyPolynomial operator[](size_t degree) { 
        return ProxyPolynomial{*this, degree}; 
    }
